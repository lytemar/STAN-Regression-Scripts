# fit_snr_all_std_vars_3rd_order_remove_high_loos_reduce_model_stan.R
...
df_snr_all_std_vars_3rd_order_remove_high_loos_reduce_mod = df

# Remove rows with LOOCV p_loo > 0.7
df_snr_all_std_vars_3rd_order_remove_high_loos_reduce_mod =
  df_snr_all_std_vars_3rd_order_remove_high_loos_reduce_mod[-c(381, 366, 385),]
...
assign(prefix, 
       fit_stan_model(
         ...
         prefix = prefix,
         X_mats = X,
         df = df_snr_all_std_vars_3rd_order_remove_high_loos_reduce_mod,
